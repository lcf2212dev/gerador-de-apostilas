...
MIN_MINUTOS = 20
MAX_MINUTOS = 45
# Reserva média dos elementos de uma aula bem construída, usada no orçamento de palavras.
RESERVA_ELEMENTOS_MIN = 8.0
...
def revisar_didatica(analise: dict) -> list[str]:
    ...
    if caixas and palavras / caixas < 250:
        avisos.append(f"1 caixa de sinalização a cada {int(palavras / caixas)} palavras — "
                      "densidade alta demais, a sinalização perde efeito (mínimo: 250)")
