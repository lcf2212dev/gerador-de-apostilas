...
.venv/bin/python .grok/skills/qconcursos/scripts/qc.py raiox --disciplina "Direito Constitucional" --banca FGV
.venv/bin/python .grok/skills/qconcursos/scripts/qc.py questoes --disciplina "Direito Constitucional" --banca FGV --max 80
.venv/bin/python .grok/skills/qconcursos/scripts/qc.py editais --orgao TRT --ano 2024
```
...
por prova, **grok-4.6** (é extração mecânica contra uma taxonomia
...
Use grok-4.6 em todas as fases.
