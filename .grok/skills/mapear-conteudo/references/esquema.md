...
python3 $S consultar <slug> --classe A --classe B --folhas --json   # o que priorizar
python3 $S ordem <slug> --folhas --json                             # em que ordem estudar
python3 $S no <slug> DC.03.02 --json                                # ficha + vizinhança
python3 $S resumo <slug> --json                                     # confiabilidade do grafo
```
